...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (pathname === '/admin/login') {
    return (
      <div className="dark min-h-screen bg-neutral-950 text-neutral-100 font-sans antialiased">
        {children}
      </div>
    );
  }
  ...
  return (
    <div className="dark min-h-screen bg-neutral-950 text-neutral-100 flex font-sans antialiased select-none">
      {/* 1. Sidebar Panel */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-neutral-950">
        ...
        <main className="flex-1 overflow-y-auto p-8 bg-neutral-950">{children}</main>
      </div>
    </div>
  );
}
