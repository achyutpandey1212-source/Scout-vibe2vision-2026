 ...
 *           404 NOT FOUND PAGE
 * ==========================================
 * Redesigned system 404 page following Scout Editorial Design Language
 */
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-6 py-8 sm:py-12 px-4 max-w-xl mx-auto select-none">
        ...
        <div className="space-y-2 max-w-md">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground font-light leading-relaxed">
            The page may have moved, the link may be outdated, or it might never have existed.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 pt-2 w-full sm:w-auto">
          <Link
            ...
            className="w-full sm:w-auto px-6 py-2.5 bg-primary text-primary-foreground text-xs font-medium rounded-xl hover:opacity-90 transition-all shadow-sm flex items-center justify-center gap-2"
          >
          ...
          >
            <Compass className="w-4 h-4 text-muted-foreground/70" />
