...
7. ENUMS:
   ...
   - "organizationType": Choose exactly one: GOVERNMENT, MNC, STARTUP, NGO, UNIVERSITY, FOUNDATION, COMMUNITY, OTHER.
    - "category": Choose exactly one: INTERNSHIPS, STARTUP_INTERNSHIPS, HACKATHONS, SCHOLARSHIPS, FELLOWSHIPS, GOVERNMENT_INTERNSHIP, RESEARCH_INTERNSHIP, CAMPUS_AMBASSADOR, OPEN_SOURCE_PROGRAM, SUMMER_SCHOOL, BOOTCAMP, WOMEN_IN_TECH.
